...
diff game-30-99-1.log game-30-99-2.log | grep -e "<" -e ">" -e "|" | wc -l

echo "diff between 1 and 3"
diff game-30-99-1.log game-30-99-3.log | grep -e "<" -e ">" -e "|" | wc -l

echo "diff between 2 and 3"
diff game-30-99-2.log game-30-99-3.log | grep -e "<" -e ">" -e "|" | wc -l

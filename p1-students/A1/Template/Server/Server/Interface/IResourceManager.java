...
public interface IResourceManager extends Remote {
    ...
    /**
     * Unreserve a seat on this flight.
     *
     * @return Success
     */
    public boolean unreserveFlight(int customerID, int flightNumber)
            throws RemoteException;

    /**
     * Unreserve a car at this location.
     *
     * @return Success
     */
    public boolean unreserveCar(int customerID, String location)
            throws RemoteException;

    /**
     * Unreserve a room at this location.
     *
     * @return Success
     */
    public boolean unreserveRoom(int customerID, String location)
            throws RemoteException;

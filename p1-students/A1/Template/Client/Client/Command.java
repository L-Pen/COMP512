...
public enum Command {
	...
	AddFlight("Add a new flight number",
	...
	DeleteCustomer("Delete a customer (and return all reservations)",
			"<CustomerID>"),

	QueryFlight("Query the number of available seats on a flight number",
			"<FlightNumber>"),
	QueryCars("Query the number of available cars at a location", "<Location>"),
	QueryRooms("Query the number of available rooms at a location",
			"<Location>"),
	QueryCustomer("Query a customer's bill", "<CustomerID>"),

	QueryFlightPrice("Query the price per seat on a flight number",
			"<FlightNumber>"),
